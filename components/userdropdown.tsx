...
// import VaultINR from "@/components/vault/vaultmain"; // <-- make sure correct path
// import UserVipCard from "@/components/form/vip";
// import showStatistics from "@/app/statistics/page";
...
//   useEffect(() => {
//     document.body.style.overflow = showVipForm || showVault ? "hidden" : "";
//   }, [showVipForm, showVault]);
...
//     { label: "Vault", icon: Vault, popup: "vault" }, // popup modal
//     { label: "VIP", icon: Trophy, popup: "vip" }, // popup modal
...
const UserDropdown: React.FC = () => {
  ...
  useEffect(() => {
    document.body.style.overflow =
      showVipForm || showVault || showStats ? "hidden" : "";
  }, [showVipForm, showVault, showStats]);
