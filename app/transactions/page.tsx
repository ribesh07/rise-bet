...
//                 )}
//                 {active === "Others" && (
//                   <div className="h-full w-full flex-1 flex items-center justify-center text-gray-300">
//                     <OtherHistory />
//                   </div>
//                 )}
//               </div>
    ...
    <div className="flex min-h-screen bg-[#0f172a] text-white relative overflow-hidden">
      ...
      {!isMobile && (
        <motion.aside
          ...
          transition={{ type: 'spring', stiffness: 300, damping: 30 }}
          className="fixed top-0 left-0 h-full bg-[#101620]/90 backdrop-blur-md z-50 border-r border-white/10"
        >
          <Sidebar
            collapsed={sidebarCollapsed}
            setCollapsed={setSidebarCollapsed}
      ...
      {/* ✅ Main Content */}
      <motion.main
        className="flex-1 flex flex-col overflow-y-auto px-3 md:px-8 pb-20 pt-[80px]"
        animate={{
          marginLeft: !isMobile
            ? sidebarCollapsed
              ? collapsedWidth
      ...
      <AnimatePresence>
        {isMobile && sidebarOpen && (
          <motion.div
            ...
            exit={{ x: -256 }}
            transition={{ type: 'spring', stiffness: 300, damping: 30 }}
            className="fixed inset-y-0 left-0 z-50 w-64 bg-[#101620]/90 backdrop-blur-md"
          >
            <Sidebar
              collapsed={false}
              setCollapsed={() => {}}
