...
// import { TopAuthNav } from "@/components/ui/topauth";
// import { SignupForm } from "@/components/auths/signupform";

// export default function SignupPage() {
//   return (
//    <div className="min-h-screen flex items-center justify-center bg-[#0b0d17]">
//          <div className="w-full h-screen sm:h-auto sm:w-full sm:max-w-md md:max-w-xl lg:max-w-2xl bg-[#101426] sm:rounded-b-xl shadow-lg flex flex-col">
//            <TopAuthNav sidebarWidth={0} />
   
//            {/* Content area */}
//            <div className="overflow-y-auto px-6 md:px-8 py-6 flex flex-col justify-center">
//              <SignupForm />
//            </div>
//          </div>
//        </div>
