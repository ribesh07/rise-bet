...
// // // //   return (
// // // //     <div className="min-h-screen bg-[#101620db] flex flex-col">
// // // //       {/* Header/Navbar (slides horizontally but stays fixed vertically) */}
// // // //       <div
// // // //         className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500`}
// // // //         style={{ marginLeft: sidebarOpen ? `${sidebarWidth}rem` : `${collapsedWidth}rem` }}
// // // //       >
// // // //         <header className="bg-[#0f172a] backdrop-blur-sm border-b border-slate-700 h-16 flex items-center px-4 sm:px-6 lg:px-8">
// // // //           <div className="flex items-center justify-between w-full">
// // // //             <div className="relative w-36 h-10">
// // // //               <Image src="/logo.png" alt="Logo" fill style={{ objectFit: "contain" }} priority />
// // // //             </div>
...
// // //   const sidebarWidth = 256; // expanded
// // //   const collapsedWidth = 80; // collapsed

// // //   return (
// // //     <div className="min-h-screen bg-[#101620db] flex flex-col">
// // //       {/* Navbar (fixed vertically, slides horizontally) */}
// // //       <div
// // //         className="fixed top-0 left-0 right-0 z-50 transition-all duration-500"
// // //         style={{ marginLeft: sidebarOpen ? sidebarWidth : collapsedWidth }}
// // //       >
// // //         <header className="bg-[#0f172a] backdrop-blur-sm border-b border-slate-700 h-16 flex items-center px-4 sm:px-6 lg:px-8">
// // //           <div className="flex items-center justify-between w-full">
// // //             <div className="relative w-36 h-10">
...
// // //           {/* Trending Sports, Promotions, Recent Bets ... (rest same as before) */}
// // //         </main>
// // //       </div>
...
//       <div className="flex flex-1 relative pt-16">
//         {/* Sidebar */}
//         <div className="fixed top-16 left-0 h-[calc(100%-4rem)] z-20 transition-all duration-500"
...
//         {/* Main Content */}
//         <main
//           className="flex-1 overflow-y-auto scrollbar-hide p-4 sm:p-6 lg:p-8 space-y-8 transition-all duration-500"
//           style={{ marginLeft: currentSidebarWidth }}
//         >
//           {/* Hero Section */}
//           <div className="header-bg w-full relative">
...
//           {/* Trending Sports, Promotions, Recent Bets ... same as before */}
//         </main>
//       </div>
