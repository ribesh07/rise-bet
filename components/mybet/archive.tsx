...
// // const Archive = () => {
// //   const bets: any[] = []; // Replace with real data later
...
// //         <p className="text-sm mb-2">No Archived Bets</p>
...
// //   return <div>Archived Bets will be listed here</div>;
// // };
...
// const Archive = () => {
//   const archivedBets: any[] = [];

//   return (
//     <div className="w-full p-4 bg-[#0e1926] rounded-lg shadow-md">
//       <div className="border border-[#1c2a3a] rounded-lg overflow-hidden">
//         {/* Header Row */}
//         <div className="grid grid-cols-3 text-sm font-semibold text-gray-300 bg-[#122131] px-6 py-3">
//           <span>Date</span>
//           <span>Count</span>
...
//           <div className="flex flex-col items-center justify-center py-16 bg-[#122131]">
//             <div className="flex flex-col items-center">
//               <div className="relative">
//                 <BarChart3 className="w-12 h-12 text-gray-500 opacity-40" />
//                 <div className="absolute top-1 left-3 w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
//               </div>
...
//           </div>
//         ) : (
//           <div className="bg-[#122131] divide-y divide-[#1c2a3a]">
//             {archivedBets.map((bet, index) => (
//               <div
//                 key={index}
//                 className="grid grid-cols-3 px-6 py-3 text-gray-300 text-sm"
//               >
//                 <span>{bet.date}</span>
//                 <span>{bet.count}</span>
//                 <span className="text-right cursor-pointer text-blue-400 hover:underline">
//                   View
//                 </span>
//               </div>
//             ))}
