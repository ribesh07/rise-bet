...
//   onSearchChange: (value: string) => void;
//   wallets: any[];
//   onCurrencyChange?: (currency: string) => void; // <-- NEW
// }
...
//   // ✅ Load API wallets instead of static wallets
//   useEffect(() => {
//     if (!walletsProp || walletsProp.length === 0) return;

//     const converted = walletsProp.map((w: any) => {
//       const icon = walletIcons.find((i) => i.symbol === w.currency)?.icon;

//       return {
//         symbol: w.currency,
//         balance: parseFloat(w.balance || "0"),
//         icon: icon || "/images/default.svg",
//       };
//     });
...
//   useEffect(() => {
//     const f = wallets.filter((w) =>
//       w.symbol.toLowerCase().includes(searchTerm.toLowerCase())
//     );
//     setFilteredWallets(f);
//   }, [searchTerm, wallets]);
...
//   // 🔥 return currency type to parent
//   if (onCurrencyChange) {
