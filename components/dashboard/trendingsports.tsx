...
export const TrendingSports: React.FC = () => {
  ...
  return (
    <section>
      <h2 className="text-xl sm:text-2xl font-bold text-white mt-4 mb-4">🏆 Trending Sports</h2>

      <div className="grid grid-cols-2 mt-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-3 sm:gap-4">
      ...
      {/* Modal appears if selectedSport is set */}
      <ComingSoonModal
