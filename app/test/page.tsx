  ...
  return (
    <div className="flex min-h-screen bg-[#0f172a] text-white overflow-x-hidden">
      ...
      <motion.div
        ...
        animate={{ marginLeft: isMobile && sidebarOpen ? sidebarWidth * 4 : 0 }}
        transition={{ type: "spring", stiffness: 300, damping: 30 }}
      >
        {/* Mobile Sidebar */}
        <AnimatePresence>
        ...
        <main className="flex-1 overflow-auto pb-16">
          ...
          <div className="w-full px-3 md:px-8 py-6 relative header-bg">
            ...
            <div className={`grid gap-4 w-full max-w-full mx-auto relative z-10 ${isMobile ? "grid-cols-1" : "grid-cols-3"}`}>
              {/* Progress Card */}
              <div className="w-full flex justify-center">
                <div className="w-full max-w-sm frosted-card-bg p-4">
                  <ProgressCard username="shark491" progressPercentage={45} levelName="Bronze" />
                </div>
              </div>
                ...
                <>
                  <div className="w-full flex justify-center">
                    <div className="w-full max-w-sm">
                      <ImageHead title="Casino" count={32339} image="/images/risebet_casino.png" />
                    </div>
                  </div>

                  <div className="w-full flex justify-center">
                    <div className="w-full max-w-sm">
                      <ImageHead title="Sports (soon...)" count={0} image="/images/risebet_sports.png" />
                    </div>
                  </div>
                </>
              )}
          ...
          {/* Trending Games */}
          <section className="mt-4 px-3 md:px-8 relative">
