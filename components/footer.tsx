...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#101b22dd] backdrop-blur-md text-gray-300 px-6 sm:px-10 md:px-20 py-10 text-sm">
  ...
  {/* Tablet/Desktop Grid */}
  <div className="hidden md:grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-5 overflow-x-auto">
  ...
  <div className="space-y-3 text-xs text-gray-400">
    <p>© 2025 playrise.vip | All Rights Reserved.</p>
    <p>
      ...
      Rare Limited and MRS Tech Limited. Contact us at support@playrise.vip.
    </p>
    <p>
