        ...
        <div className="min-w-[650px]">
          ...
          {withdrawals.length === 0 ? (
            <div className="flex flex-col items-center justify-center text-center py-12">
              ...
              <p className="text-gray-400 mt-4 font-medium">No Withdrawals Found</p>
            </div>
          ) : (
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-[#1e293b] p-6 rounded-xl w-[90%] max-w-md shadow-lg border border-slate-700 relative">
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <p>
                <span className="text-gray-400">Date:</span> {selectedWithdrawal.date}
              </p>
              <p>
              ...
              <p>
                <span className="text-gray-400">Amount:</span> {selectedWithdrawal.amount}
              </p>
              <p>
                <span className="text-gray-400">Method:</span> {selectedWithdrawal.method}
              </p>
              <p>
