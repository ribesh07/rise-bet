...
import WalletPopup from "@/components/wallet/walletmain"; // ✅ Import your popup
...
const TopNavbar: React.FC<TopNavbarProps> = ({ searchValue, onSearchChange }) => {
  ...
  const [showWalletPopup, setShowWalletPopup] = useState(false); // ✅ New state
  ...
  const openWalletPopup = () => {
    setIsDropdownOpen(false);
    setShowWalletPopup(true); // ✅ Open popup
  };
          ...
          {isDropdownOpen && (
            <div className="absolute top-12 left-1/2 -translate-x-1/2 
              ...
              <div
                ...
                className="border-t border-[#2b3340] bg-[#0f1a23] px-4 py-2 flex items-center justify-center hover:bg-[#1a2633] cursor-pointer transition"
              >
