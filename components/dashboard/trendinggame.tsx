...
import React, { useState } from 'react';
import { TrendingUp } from 'lucide-react';
import ComingSoonModal from '@/components/form/loginmodel';
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-3 sm:gap-4">
        {trendingGames.map((game) => (
          <div
            ...
            className="bg-slate-800 hover:bg-slate-700 transition-all cursor-pointer rounded-xl 
                       w-full h-[180px] md:h-[220px] flex flex-col overflow-hidden"
          >
            {/* IMAGE */}
            <img
              src={game.image}
            ...
            {/* CONTENT */}
            <div className="h-[30%] flex flex-col items-center justify-center px-2 text-center">
              ...
              <div className="flex items-center text-green-400 text-[10px] sm:text-xs mt-1">
